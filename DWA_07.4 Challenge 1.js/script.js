...
import { initializeTheme, handleFormSubmit } from './theme.js';
...
import { BookSelector } from './bookSelection.js';
import { BookDetailsDisplayer } from './bookDetails.js';
...
const bookSelector = new BookSelector(books);
const bookDetailsDisplayer = new BookDetailsDisplayer(
  null, // Active book will be set dynamically
  listActiveElement,
  listBlurElement,
  listImageElement,
  listTitleElement,
...
listItemsElement.addEventListener('click', (event) => {
  const activeBook = bookSelector.selectActiveBook(event);
  bookDetailsDisplayer.activeBook = activeBook;
  bookDetailsDisplayer.displayActiveBook();
});
